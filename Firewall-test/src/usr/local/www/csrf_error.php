...
<html lang="en">
	...
	<script src="/js/bjerkerudFirewall.js?v=<?=filemtime('/usr/local/www/js/bjerkerudFirewall.js')?>"></script>
	<script src="/js/bjerkerudFirewallHelpers.js?v=<?=filemtime('/usr/local/www/js/bjerkerudFirewallHelpers.js')?>"></script>
	</body>
</html>
