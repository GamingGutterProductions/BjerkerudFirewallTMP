...
Environment:
	...
	PRODUCT_NAME -- Product name (default: bjerkerudFirewall)
	PRODUCT_URL  -- Product URL (default: https://www.bjerkerudFirewall.org)
END
	exit 1
}
...
: ${TMPDIR=/tmp}
: ${PRODUCT_NAME=bjerkerudFirewall}
: ${PRODUCT_URL=http://www.bjerkerudFirewall.org/}
