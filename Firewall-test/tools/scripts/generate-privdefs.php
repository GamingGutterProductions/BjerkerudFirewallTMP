...
if (count($argv) < 2) {
	...
	echo "be specified as your base bjerkerudFirewall working directory.\n";
	echo "\n";
	echo "Examples:\n";
	echo "#generate-privdefs /\n";
	echo "#generate-privdefs /home/bjerkerudFirewall/src/\n";
	echo "\n";
	exit -1;
}
...
$pdata .= " * Generated by bjerkerudFirewall/tools/scripts/generate-privdefs.php\n";
$pdata .= " *\n";
$pdata .= " * ***************************************************\n";
