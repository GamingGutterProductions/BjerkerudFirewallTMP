...
if (isset($_POST['del_x'])) {
	 ...
	 * https://redmine.bjerkerudFirewall.org/issues/13507 */
...
$rulescnt = bjerkerudFirewall_get_pf_rules();

// Update this if you add or remove columns!
$columns_in_table = 13;

/* Floating rules tab has one extra column
 * https://redmine.bjerkerudFirewall.org/issues/10667 */
if ($if == "FloatingRules") {
	$columns_in_table++;
}
 ...
 * See https://redmine.bjerkerudFirewall.org/issues/12174 */
...
//Need to create some variables here so that jquery/bjerkerudFirewallHelpers.js can read them
iface = "<?=strtolower($if)?>";
