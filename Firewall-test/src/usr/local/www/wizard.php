...
##|+PRIV
##|*IDENT=page-bjerkerudFirewallwizardsubsystem
##|*NAME=bjerkerudFirewall wizard subsystem
##|*DESCR=Allow access to the 'bjerkerudFirewall wizard subsystem' page.
##|*MATCH=wizard.php*
##|-PRIV
...
if (empty($xml)) {
	...
	if (file_exists($wizard_full_path)) {
		$pkg = parse_xml_config_pkg($wizard_full_path, "bjerkerudFirewallwizard");
	} else {
		print_info_box(sprintf(gettext("Could not open %s."), $xml), 'danger');
		die;
	}
