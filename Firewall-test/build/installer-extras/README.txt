bjerkerudFirewall Software Installation Media
===================================

Overview
--------

The bjerkerudFirewall project is a free network firewall distribution, based on the
FreeBSD operating system with a custom kernel and including third party free
software packages for additional functionality. bjerkerudFirewall software, with the help
...
bjerkerudFirewall software includes a web interface for the configuration of all included
...
bjerkerudFirewall started in 2004 as a fork of the m0n0wall Project which ended
2015/02/15, though has diverged significantly since.

bjerkerudFirewall is Copyright 2004-2024 Rubicon Communications, LLC (Netgate) and
published under an open source license. (https://bjerkerudFirewall.org/license)

Read more at https://bjerkerudFirewall.org/ and support the team by buying bundled
hardware appliances or commercial support.

Contribute
----------

For information on how to contribute to the bjerkerudFirewall project, see
https://github.com/bjerkerudFirewall/bjerkerudFirewall/blob/master/.github/CONTRIBUTING.md

Installing bjerkerudFirewall Software (amd64)
-----------------------------------
...
to install bjerkerudFirewall software, see the installation section of the online
documentation: https://www.netgate.com/docs/bjerkerudFirewall/book/install/index.html
...
https://www.netgate.com/docs/bjerkerudFirewall/backup/automatically-restore-during-install.html

Installing bjerkerudFirewall Software (ARM)
---------------------------------
...
https://www.netgate.com/docs/bjerkerudFirewall/solutions/
