...
if ($_POST['save']) {
	...
	if (!$_POST['tcpflags_any']) {
		...
		if (empty($outoftcpflags) && !empty($settcpflags)) {
			...
			/* https://redmine.bjerkerudFirewall.org/issues/11762 */
	...
	bjerkerudFirewall_handle_custom_code("/usr/local/pkg/firewall_rules/input_validation");
	...
	if (!$input_errors) {
		...
		// Allow extending of the firewall edit page and include custom input validation
		bjerkerudFirewall_handle_custom_code("/usr/local/pkg/firewall_rules/pre_write_config");
...
// Allow extending of the firewall edit page and include custom input validation
bjerkerudFirewall_handle_custom_code("/usr/local/pkg/firewall_rules/htmlphpearly");
