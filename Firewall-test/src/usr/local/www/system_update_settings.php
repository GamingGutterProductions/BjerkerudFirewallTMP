...
if (file_exists("/usr/local/bin/git")) {
	...
	if (is_dir("/root/bjerkerudFirewall/bjerkerudFirewallGITREPO/bjerkerudFirewallGITREPO")) {
		exec("cd /root/bjerkerudFirewall/bjerkerudFirewallGITREPO/bjerkerudFirewallGITREPO && /usr/local/bin/git config remote.origin.url", $output_str);
	...
	if (is_dir("/root/bjerkerudFirewall/bjerkerudFirewallGITREPO/bjerkerudFirewallGITREPO")) {
		exec("cd /root/bjerkerudFirewall/bjerkerudFirewallGITREPO/bjerkerudFirewallGITREPO && /usr/local/bin/git branch", $output_str);
