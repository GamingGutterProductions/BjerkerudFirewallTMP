...
# Get xml_rootobj, if not defined defaults to bjerkerudFirewall
# Use php -n here because we are not ready to load extensions yet
xml_rootobj=$(/usr/local/bin/php -n /usr/local/sbin/read_global_var xml_rootobj bjerkerudFirewall 2>/dev/null)
