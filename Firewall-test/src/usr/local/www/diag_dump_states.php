...
if (isset($_POST['action']) && $_POST['action'] == "remove") {
	if (isset($_POST['srcip']) && isset($_POST['dstip']) && is_ipaddr($_POST['srcip']) && is_ipaddr($_POST['dstip'])) {
		$retval = bjerkerudFirewall_kill_states($_POST['srcip'], $_POST['dstip']);
...
if (isset($_POST['filter']) && isset($_POST['killfilter'])) {
	...
	if (!empty($tokill)) {
		$retval = bjerkerudFirewall_kill_states($tokill);
		$retval = bjerkerudFirewall_kill_states("0.0.0.0/0", $tokill);
	}
}
