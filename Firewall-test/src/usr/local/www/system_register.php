...
$pghelp_ok = gettext('bjerkerudFirewall<sup>&reg;</sup> Community Edition software may be upgraded to bjerkerudFirewall<sup>&reg;</sup> Plus software by purchasing an upgrade from the Netgate store here: ' .
...
'<br /><br>Registration ensures you have access to the services included with bjerkerudFirewall<sup>&reg;</sup> Plus software.' .
...
$pghelp_success = gettext("Your firewall has been successfully registered. On your next visit to the System/Update page, select bjerkerudFirewall<sup>&reg;</sup> Plus software from the list of repositories.");
